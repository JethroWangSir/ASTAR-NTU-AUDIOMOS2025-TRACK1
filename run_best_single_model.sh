...
python train.py \
    --expname primary_model_gaussian_listwise_mi_lambda_0.01_decoupled_alignment_ta_lambda_0.01 \
...
python train.py \
    --expname primary_model_gaussian_listwise_mi_lambda_0.01_decoupled_alignment_ta_lambda_0.05 \
    --model_type muq_roberta_transformer_dist \
    --datadir /share/nas169/jethrowang/MusicEval-full \
    --train_list_path /share/nas169/jethrowang/MusicEval-full/sets/train_mos_list.txt \
    --validation_list_path /share/nas169/jethrowang/MusicEval-full/sets/dev_mos_list.txt \
...
python train.py \
    --expname primary_model_gaussian_listwise_mi_lambda_0.01_decoupled_alignment_ta_lambda_0.1 \
    --model_type muq_roberta_transformer_dist \
    --datadir /share/nas169/jethrowang/MusicEval-full \
    --train_list_path /share/nas169/jethrowang/MusicEval-full/sets/train_mos_list.txt \
    --validation_list_path /share/nas169/jethrowang/MusicEval-full/sets/dev_mos_list.txt \
...
python train.py \
    --expname primary_model_gaussian_listwise_mi_lambda_0.01_decoupled_alignment_ta_lambda_0.5 \
    --model_type muq_roberta_transformer_dist \
    --datadir /share/nas169/jethrowang/MusicEval-full \
    --train_list_path /share/nas169/jethrowang/MusicEval-full/sets/train_mos_list.txt \
    --validation_list_path /share/nas169/jethrowang/MusicEval-full/sets/dev_mos_list.txt \
